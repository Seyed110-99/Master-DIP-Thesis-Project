...
x_dummy = torch.zeros((1, 1, physics.img_width, physics.img_width), device=device)
...
def classic_TV_solver(lambs, image_path, noise_level = "none"):
    ...
    A_norm = physics.compute_norm(physics.A_dagger(walnut_data)).item() # Compute the norm of the forward operator§
    stepsize = 1 / (A_norm**2 + 1e-12)  # Compute the stepsize based on the norm of the forward operator
...
if __name__ == "__main__":
    ...
    best_stepsize_no, best_lamb_no, best_psnr_no = classic_TV_solver(lambs, image_path_no_noise, noise_level="none")
    ...
    best_stepsize_low, best_lamb_low, best_psnr_low = classic_TV_solver(lambs, image_path_low_noise, noise_level="low")
    ...
    best_stepsize_high, best_lamb_high, best_psnr_high = classic_TV_solver(lambs, image_path_high_noise, noise_level="high")
