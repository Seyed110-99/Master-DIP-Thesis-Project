...
def ellipses_DIP_dl(walnut_GT, img_num ,lambs, noise_level = "none", model_type = "ellipses", input_type = "z", critic_noise = "low"):
    ...
    if input_type == "z":
        ...
        critic.load_state_dict(torch.load("checkpoints/pre_model_img.pth", map_location=device))
    ...
    for lamb in lambs:
        ...
        # plt.axis('off')
        os.makedirs(f"results_img_more/DIP_dl_critic/{model_type}/{noise_level}", exist_ok=True)
        ...
        for critic_noise in critic_noises:
            for model_type in models:
                for noise_level in noise_levels:
                    ...
                    plt.legend()
                    out_dir = f"results_img_more/DIP_dl_critic/{model_type}/{noise_level}"
                    os.makedirs(out_dir, exist_ok=True)
